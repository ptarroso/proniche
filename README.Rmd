...
Note that, in the case of Domain, all occurrence observations have maximum similarity. A test dataset can be used instead:

```{r trunc_test, warning=FALSE, fig.width=4, fig.height=4}
...
```{r modev, fig.width=6, fig.height=6, results='hide', message=FALSE}
library(modEvA)
library(pROC)
library(kuenm)
library(raster)
