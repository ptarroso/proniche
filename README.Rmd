...
- Functions for computing niche models using a variety of **truly presence-only methods** (i.e., methods that use only environmental data from the presence sites, with no background or pseudo-absence data):
